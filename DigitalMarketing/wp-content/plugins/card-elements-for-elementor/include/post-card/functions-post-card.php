    ...
    function post_card_posted_categories() {
        ...
        if ($categories_list) {
            printf(
                    ...
                    '<span class="cat-links">%1$s<span class="screen-reader-text">%2$s</span>%3$s</span>', '', esc_html__('Posted in', 'card-elements-for-elementor'), $categories_list
            ); // WPCS: XSS OK.
        }
    }
    ...
    function post_card_posted_tag() {
        ...
        if ($tags_list) {
            printf(
                    ...
                    '<div class="post-card-tags"><span class="tags-links">%1$s<span class="screen-reader-text">%2$s </span>%3$s</span> </div>', '<i class="fa fa-tags" aria-hidden="true"></i>', esc_html__('Tags:', 'card-elements-for-elementor'), $tags_list
            ); // WPCS: XSS OK.
        }
    }
